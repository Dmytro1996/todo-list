...
public class ToDoController {
    ...
    public String read(@PathVariable long id, Model model) {
        ToDo todo = todoService.getAll().stream().filter(t->t.getId()==id).findAny().get();//todoService.readById(id);
    ...
    @PreAuthorize("hasAuthority('ADMIN') or hasAuthority('USER') and #ownerId == authentication.principal.id")
